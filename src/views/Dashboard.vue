...
import { ref } from 'vue'
import { IconPlus, IconClockCircle, IconSettings } from '@arco-design/web-vue/es/icon';
      ...
      <a-col :span="8">
        <a-card class="stats-card">
          ...
          <a-grid :cols="2" :colGap="16" :rowGap="16">
            ...
            <a-grid-item>
              <a-statistic title="售票中" :value="statistics.performances.onSale" value-style="color: var(--color-success)" />
            </a-grid-item>
            <a-grid-item>
      ...
      <a-col :span="8">
        <a-card class="stats-card">
          ...
          <a-grid :cols="2" :colGap="16" :rowGap="16">
            ...
            <a-grid-item>
              <a-statistic title="今日订单" :value="statistics.orders.today" value-style="color: var(--color-success)" />
            </a-grid-item>
            <a-grid-item>
              <a-statistic title="待处理" :value="statistics.orders.pending" value-style="color: var(--color-warning)" />
            </a-grid-item>
            <a-grid-item>
      ...
      <a-col :span="8">
        <a-card class="stats-card">
          ...
          <a-grid :cols="2" :colGap="16" :rowGap="16">
            ...
            <a-grid-item>
              <a-statistic title="今日收入" prefix="¥" :value="statistics.revenue.today" value-style="color: var(--color-success)" />
            </a-grid-item>
          </a-grid>
        </a-card>
      </a-col>
