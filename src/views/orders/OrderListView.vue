    ...
    <div class="order-list">
        <a-card class="general-card" title="订单管理">
            ...
            <div class="search-area">
                <a-row :gutter="16">
                    <a-col :span="8">
                        <a-input-search v-model="searchKeyword" placeholder="搜索订单号/用户名/演出名称" allow-clear
                            @search="handleSearch" />
                    </a-col>
                    <a-col :span="4">
                        <a-select v-model="statusFilter" placeholder="订单状态" allow-clear style="width: 100%"
                    ...
                    <a-table-column title="操作" align="center">
                        <template #cell="{ record }">
                            <a-space>
                                ...
                                <a-button v-if="record.status === 'paid'" type="text" status="danger" size="small"
        ...
        <!-- 订单详情抽屉 -->
        <a-drawer v-model:visible="drawerVisible" title="订单详情" width="600px">
